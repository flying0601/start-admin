...
//对Router原型链上的push、replace方法进行重写。这样就避免每次调用时还要加上捕获异常方法
...
export const asyncRoutes = [
  //商品管理
  {
    path: '/shop/goods',
    name: 'Goods',
    redirect: '/shop/goods/category-goods',
    component: Layout,
    meta: {
      title: '商品管理',
    ...
    children: [
      {
        path: 'category-goods',
        name: 'CategoryGoods',
        component: () => import('@/views/shop/goods/category-goods'),
        meta: {
          title: '商品分类',
          icon: 'el-icon-table iconfont'
        }
      },
      {
        path: 'module-goods',
        name: 'ModuleGoods',
        component: () => import('@/views/shop/goods/module-goods'),
        meta: {
          title: '商品列表',
          icon: 'el-icon-table iconfont'
        }
    ...
    children: [
      {
        path: 'buy-order',
        name: 'BuyOrder',
        component: () => import('@/views/shop/order/buy-order'),
        meta: {
          title: '购买订单',
          icon: 'el-icon-table iconfont'
        }
      },
      {
        path: 'prize-order',
        name: 'PrizeOrder',
        component: () => import('@/views/shop/order/prize-order'),
        meta: {
          title: '获奖订单',
          icon: 'el-icon-table iconfont'
        }
